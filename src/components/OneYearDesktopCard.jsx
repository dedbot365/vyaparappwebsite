...
const OneYearDesktopCard = ({
  ...
  const actualSilverPrice = 80;
  const actualGoldPrice = 140;

  const discountSilverPrice = 53.99;
  const discountGoldPrice = 80.99;
        ...
        <div className="flex justify-between items-center py-3 gap-2">
          ...
          >
            <div>
              ...
              <p className="text-sm font-semibold text-gray-800">Desktop</p>
            </div>
            <div>
              <span className="text-blue-600">
                <IoIosArrowDropdownCircle />
          ...
          {dropdownTwo && (
            <div className="flex flex-col absolute top-24 right-80 bg-white w-32 rounded-md shadow-lg">
              <ul className="flex flex-col gap-2 text-xs p-3">
                ...
                <Link to="/oneYearMobilePage" className="active:font-bold">
                  Mobile
                </Link>
              </ul>
            </div>
...
export default OneYearDesktopCard;
