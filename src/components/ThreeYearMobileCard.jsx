...
const ThreeYearMobileCard = ({
  ...
  const actualSilverPrice = 75;
  const actualGoldPrice = 120;

  const discountSilverPrice = 39.99;
  const discountGoldPrice = 59.99;
...
export default ThreeYearMobileCard;
