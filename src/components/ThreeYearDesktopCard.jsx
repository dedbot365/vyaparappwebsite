...
const ThreeYearDesktopCard = ({
  ...
  const actualSilverPrice = 200;
  const actualGoldPrice = 300;

  const discountSilverPrice = 111.99;
  const discountGoldPrice = 159.99;
...
export default ThreeYearDesktopCard;
